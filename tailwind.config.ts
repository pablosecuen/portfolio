  ...
  theme: {
    ...
    extend: {
      ...
      backgroundImage: {
        ...
        primherofull: "url('../public/assets/proyects/primherofull.png')",
        primheromb: "url('../public/assets/proyects/primheromb.png')",
        meduxafull: "url('../public/assets/proyects/meduxafull.png')",
        meduxamb: "url('../public/assets/proyects/meduxamb.png')",
        comexfull: "url('../public/assets/proyects/comexfull.png')",
        ...
        raffleappmb: "url('../public/assets/proyects/raffleappmb.png')",
        raffleappfull: "url('../public/assets/proyects/raffleappfull.png')",
        campusmb: "url('../public/assets/proyects/campusmb.png')",
          campusfull: "url('../public/assets/proyects/campusfull.png')",
      },
    },
  },
  variants: {
