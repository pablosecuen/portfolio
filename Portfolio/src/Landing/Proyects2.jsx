    ...
    <div className="flex h-full w-full flex-col text-white">
      ...
      {proyects.map((proyect) => (
        <div key={proyect.name} className="flex flex-col items-center">
          <div
            key={proyect.name}
            className="flex h-full w-full  flex-col items-center justify-evenly rounded-xl border py-8 align-middle text-white md:flex-row md:gap-20 md:border-none md:py-0"
          >
            {" "}
            <motion.div
            ...
            <div className="flex-end flex h-full w-11/12 flex-col justify-end  text-center md:hidden  ">
              ...
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="item mb-20 flex w-96 justify-center self-end border  py-8 md:mb-64  md:w-1/2 md:justify-center"
              >
          ...
          <a
            ...
            target="_blank"
            rel="noreferrer"
            className="item mx-auto mb-20  flex w-3/5 justify-end   pt-8 md:mb-64 "
          >
            <motion.button
              className="text-xsm h-10 cursor-pointer rounded-3xl border bg-blue-500 p-2 px-4 text-white shadow-md shadow-black sm:text-base"
              variants={{
